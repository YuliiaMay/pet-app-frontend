...
`,Fe=()=>{const[t,r]=j.useState([]),[o,d]=j.useState(!0),[l,i]=j.useState(!1),[u,y]=j.useState(null),f=W(),h=$(Y),c=P();j.useEffect(()=>{o&&(c(I()),d(!1))},[c,o]);const g=s=>{i(!0),y(s)},b=s=>{let p=s;return p.length>20&&(p=s.slice(0,20)+"..."),p};return j.useEffect(()=>{let s=[];f.pathname==="/notices/sell"?s=h.filter(p=>p.category==="sale"):f.pathname==="/notices/lost-found"?s=h.filter(p=>p.category==="lost/found"):f.pathname==="/notices/for-free"&&(s=h.filter(p=>p.category==="in good hands")),r(s)},[f.pathname,h]),e.jsxs(L,{children:[e.jsx(xe,{children:t.map(s=>e.jsxs(me,{children:[e.jsxs(ge,{children:[e.jsx(ye,{src:s.imgUrl,alt:"pet",loading:"lazy"}),e.jsxs(be,{children:[e.jsx(we,{children:s.category}),e.jsx(ve,{children:e.jsx(je,{"aria-label":"add to favorites",children:e.jsx(v,{iconName:"icon-heart",width:"24px",height:"24px",stroke:"#54ADFF",fill:"#54ADFF"})})})]}),e.jsxs(De,{children:[e.jsxs(F,{children:[e.jsx(v,{iconName:"icon-location",width:"24px",height:"24px",stroke:"#54ADFF",fill:"#54ADFF"}),e.jsx(N,{children:s.place})]}),e.jsxs(F,{children:[e.jsx(v,{iconName:"icon-clock",width:"24px",height:"24px",stroke:"#54ADFF",fill:"#54ADFF"}),e.jsxs(N,{children:[Q(s.birthday)," year"]})]}),e.jsxs(F,{children:[e.jsx(v,{iconName:s.sex==="female"?"icon-female":"icon-male",width:"24px",height:"24px",stroke:"#54ADFF",fill:"#54ADFF"}),e.jsx(N,{children:s.sex})]})]})]}),e.jsxs(Me,{children:[e.jsx(Te,{children:b(s.title)}),e.jsxs(ke,{onClick:()=>g(s),children:[e.jsx("span",{children:"Learn more"}),e.jsx(v,{iconName:"icon-pawprint",width:"24px",height:"24px",stroke:"#54ADFF",fill:"#54ADFF"})]})]})]},s._id))}),e.jsx(S,{active:l,setShow:i,card:u})]})};Fe.propTypes={props:k.object};export{Fe as default};
