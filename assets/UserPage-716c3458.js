...
`,Fe=()=>{const[e,s]=n.useState(!1),r=()=>{s(!1)},o=()=>{s(!0)};return t.jsxs(ge,{children:[t.jsxs("div",{children:[t.jsx(ue,{children:t.jsx(fe,{children:"My information"})}),t.jsxs(be,{children:[e?t.jsx(M,{type:"button",onClick:r,children:t.jsx(re,{})}):t.jsx(M,{type:"button",onClick:o,children:t.jsx(ae,{})}),t.jsx(A,{isFormEnable:e}),t.jsx(V,{isFormEnable:e})]})]}),t.jsxs("div",{children:[t.jsxs(je,{children:[t.jsx(ve,{children:"My pets"}),t.jsxs(ye,{to:"/add-pet",children:["Add Pet",t.jsx(de,{})]})]}),t.jsx(we,{children:t.jsx(me,{})})]})]})};export{Fe as default};
