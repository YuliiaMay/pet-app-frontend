import{s as n,P as s,j as e,I as l,q as Y,N as I,d as E,r as p,b as R,k as O,u as U,t as q}from"./index-4cbd0a26.js";import{f as G,P as _,s as H}from"./index-0e75b309.js";import{M as D}from"./ModalComponents-ed4e6788.js";const J=t=>t.notices.items,K="/pet-app-frontend/assets/defaultPoster-d1161abc.jpeg",Q=t=>t||K,V=t=>t.replace(/[.\-/\\\s]/g,"");function X(t){if(!t)return;const o=new Date,r=new Date(o.getFullYear(),o.getMonth(),o.getDate()),a=new Date(t),x=new Date(r.getFullYear(),a.getMonth(),a.getDate());let c;return c=r.getFullYear()-a.getFullYear(),r<x&&(c=c-1),c}const Z=n.div`
  width: 280px;
