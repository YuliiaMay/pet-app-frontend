import{s as p,P as v,a as j,j as e,L as U}from"./index-4556a271.js";import{F as f,a as w,b as c,E as h}from"./formik.esm-ba40efa8.js";import{u as y}from"./useDispatch-4a9c4b0d.js";import{c as k,a as u,b as E}from"./index.esm-3db09ce1.js";const $=p.img`
  width: 182px;
  height: 182px;
...
`,z=p.div`
  background-color: ${t=>t.theme.background.wight};
`,S=()=>{const[t,s]=j.useState(!1),i=()=>{s(!1)},a=()=>{s(!0)};return e.jsxs(M,{children:[e.jsxs("div",{children:[e.jsx("h2",{children:"My information"}),e.jsxs(P,{children:[t?e.jsx("button",{type:"button",onClick:i}):e.jsx("button",{type:"button",onClick:a}),e.jsx(C,{isFormDisabled:t}),e.jsx(F,{isFormDisabled:t})]})]}),e.jsxs("div",{children:[e.jsx("h2",{children:"My pets"}),e.jsx(U,{to:"..add pet page",children:"Add Pet"}),e.jsx(z,{children:e.jsx(B,{})})]})]})};export{S as default};
