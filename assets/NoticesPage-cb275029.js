...
`,L=i.button`
  ...
  border: none;
  background-color: inherit;
`,F=()=>{const[e,r]=o.useState(""),c=a=>{const p=a.currentTarget.value.toLowerCase();s({query:p}),r(p)},d=a=>{if(a.preventDefault(),e.trim()===""){s();return}r("")},[l,s]=m();l.get("query");const h=()=>{r(""),s()};return t.jsxs(v,{children:[t.jsx(y,{children:"Find your favorite pet"}),t.jsxs(S,{onSubmit:d,children:[t.jsx(C,{type:"text",placeholder:"Search",value:e,onChange:c}),t.jsx(k,{type:"submit",position:e,children:t.jsx(b,{})}),e!==""&&t.jsx(L,{type:"button",onClick:h,children:t.jsx(j,{})})]})]})},$=i.div`
  display: flex;
