...
`,T=n.div`
  ...
  position: absolute;
  transform: translate(-50%, 0);
`,F=({isFormEnable:e})=>{const a=y(),[r,o]=i.useState(!1),[w,l]=i.useState(!1),s={avatar:"https://images.unsplash.com/photo-1529778873920-4da4926a72c2?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8Mnx8Y3V0ZSUyMGNhdHxlbnwwfHwwfHx8MA%3D%3D&w=1000&q=80"},$={avatar:s.avatar},z=()=>{l(!0)},H=async d=>{if(o(!1),d.target.files[0].type!=="image/jpeg"){o(!0);return}l(!1);const f=new FormData;f.append("avatar",d.target.files[0]),a(uploadImg(f))},V=d=>{d("avatar",null),l(!1)};return t.jsxs(W,{children:[r&&t.jsx("p",{children:"Only img can be uploaded"}),t.jsx(I,{src:s.avatar,alt:""}),e&&t.jsx(k,{initialValues:$,onSubmit:H,children:({values:d,setFieldValue:f})=>t.jsxs(M,{encType:"multipart/form-data",children:[t.jsx(j,{type:"file",id:"avatar",name:"avatar",accept:"image/*",value:void 0,hidden:!0}),w?t.jsxs(T,{children:[t.jsx("button",{type:"submit",children:t.jsx(B,{})}),t.jsx("p",{children:"Confirm"}),d.avatar&&t.jsx("button",{type:"button",onClick:()=>V(f),children:t.jsx(S,{})})]}):t.jsxs(U,{type:"button",onClick:z,children:[t.jsx(Z,{}),"Edit photo"]})]})})]})};F.propTypes={isFormEnable:L.bool.isRequired};const q=e=>i.createElement("svg",{width:24,height:24,viewBox:"0 0 24 24",fill:"none",xmlns:"http://www.w3.org/2000/svg",...e},i.createElement("path",{d:"M14 4L18 4C19.1046 4 20 4.89543 20 6V18C20 19.1046 19.1046 20 18 20H14M3 12L15 12M3 12L7 8M3 12L7 16",stroke:"#54ADFF",strokeWidth:1.5,strokeLinecap:"round",strokeLinejoin:"round"})),N=n(M)`
  display: flex;
  flex-direction: column;
...
`,le=n.h2`
  ...
  line-height: normal;
  letter-spacing: 0.8px;
`,me=()=>{const[e,a]=i.useState(!1),r=()=>{a(!1)},o=()=>{a(!0)};return t.jsxs(ie,{children:[t.jsxs("div",{children:[t.jsx(oe,{children:"My information"}),t.jsxs(re,{children:[e?t.jsx(v,{type:"button",onClick:r,children:t.jsx(K,{})}):t.jsx(v,{type:"button",onClick:o,children:t.jsx(_,{})}),t.jsx(F,{isFormEnable:e}),t.jsx(E,{isFormEnable:e})]})]}),t.jsxs("div",{children:[t.jsxs(ae,{children:[t.jsx(le,{children:"My pets"}),t.jsxs(de,{to:"..add pet page",children:["Add Pet",t.jsx(J,{})]})]}),t.jsx(se,{children:t.jsx(ne,{})})]})]})};export{me as default};
