...
const DetailsForm = () => {
  ...
  return (
    <Formik initialValues={initialDetailsValues} onSubmit={onNextStep}>
      <StyledForm
      ...
      >
        {(category === "sell" ||
          ...
          <>
            <Label htmlFor="title">Title of add</Label>
            <Input
        ...
        <Label htmlFor="pet-birth">Date of birth</Label>
        <Input
